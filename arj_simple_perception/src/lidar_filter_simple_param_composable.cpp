...
public:
  LidarFilterSimple(const rclcpp::NodeOptions & options = rclcpp::NodeOptions()) 
  : Node("lidar_filter_simple_param", options), count_(0)
  {
...
RCLCPP_COMPONENTS_REGISTER_NODE(LidarFilterSimple)

// int main(int argc, char *argv[])
// {
//   rclcpp::init(argc, argv);
//   auto options = rclcpp::NodeOptions();
//   auto node = std::make_shared<LidarFilterSimple>(options);
//   rclcpp::spin(node);
//   rclcpp::shutdown();
//   return 0;
// }